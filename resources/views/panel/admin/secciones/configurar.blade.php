...
@section('content')
      ...
      <div class="card card-primary card-outline">
         <div class="card-body table-responsive">
            ...
            {{-- @dump( $seccion->DesAsignaturas->where('id',211)->count() ) --}}
               ...
               <table class="table table-hover table-striped">
                  ...
                  <tbody>
                     ...
                     @foreach ($seccion->Plan->Asignaturas->where('trayecto_id',$seccion->trayecto->id) as $asignatura)
                        <tr class="bg-success bg"{{--  style=" background-color: lightgreen" --}}>
                           <th colspan="4" style="text-align: center;"  for="{{  $asignatura->codigo }}">
                             <label for="{{  $asignatura->codigo }}" style="width: 95%; cursor: pointer; height: 100%;;" class="check-asignatura">
                               ...
                               <input type="checkbox" checked="true"  id="{{  $asignatura->codigo }}" value="{{ $asignatura->id }}" name="asignaturas_ins[]" hidden="true" {{-- class="check-asignatura" --}}>
                           </th>
