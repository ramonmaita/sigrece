	...
	<style>
		...
		@font-face {
		  ...
		  src: local('american_text_bt'),
		       url({{ public_path().'/fonts/american_text_bt.ttf' }}) format('truetype');
		}
		body, h1, h2, h3, h4, h5 {
			font-family: 'american_text_bt';
			width: 100%;
...
<body >
	...
	<div class="cont" style="background-color:rgba(255, 255, 255, 0.9); background-image: url({{ public_path().'/img/fondo-titulo.png' }});">
		...
		<div class="center-img">
			<table border="0"  align="center" cellpadding="0" cellspacing="0" style="margin-top: -20px;" width="100%">
				<tr>
					...
					<td width="50%">
							...
							<img src="{{ public_path().'/img/escudo.jpg' }}" alt="" height="160px" width="160px"{{--  style="margin-left: 190px;" --}} >

							</center>
						
					</td>
					<td align="right" width="25%">
						<img src="data:image/png;base64,{{DNS2D::getBarcodePNG('https:iuteb.edu.ve/sigce/'.$graduando->nacionalidad.'/'.$graduando->cedula.'/verificar/'.$graduando->nro_titulo, 'QRCODE')}}" alt="barcode" height="120px" width="120px"  style="align: right " />
					</td>
				</tr>
				<tr>
					<td colspan="3">
			...
			@endif
				<center>
					@if ($graduando->titulo == 1)
						@php 
							echo $retVal = ($graduando->sexo == 'M') ? '<span class="inicial">T</span>écnico <span class="inicial">S</span>uperior <span class="inicial">U</span>niversitario en:' : '<span class="inicial">T</span>écnica <span class="inicial">S</span>uperior <span class="inicial">U</span>niversitaria en:'; 
						@endphp
			...
			@if ($p >= 19.50 && $p <= 20)
				<span style="font-family: 'gregorian'; font-size: 16pt; text-align: center; margin-top: 0px; padding-bottom:150px;">
					<center>
						Mención Honorifica  "Summa Cum Laude"
					</center>
				</span>
			@endif
