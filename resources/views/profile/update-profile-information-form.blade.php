<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <div class="mt-2" x-show="! photoPreview">
                    <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->nombre }}" class="object-cover w-20 h-20 rounded-full">
                </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="cedula" type="text" class="block w-full mt-1" wire:model.defer="state.cedula" autocomplete="cedula" />
            <x-jet-input-error for="cedula" class="mt-2" />
        </div>
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="nombre" value="{{ __('Nombre') }}" />
            <x-jet-input id="nombre" type="text" class="block w-full mt-1" wire:model.defer="state.nombre" autocomplete="nombre" />
            <x-jet-input-error for="nombre" class="mt-2" />
        </div>
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="apellido" value="{{ __('Apellido') }}" />
            <x-jet-input id="apellido" type="text" class="block w-full mt-1" wire:model.defer="state.apellido" autocomplete="apellido" />
