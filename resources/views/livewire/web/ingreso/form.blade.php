<div>
    ...
    <form method="POST" wire:submit.prevent="store">
        ...
        <x-web-card>
			...
			<div class="mb-2 -mx-3 md:flex">
				<div class="px-3 mb-6 md:w-full md:mb-0">
					<x-jet-label for="ingreso" value="{{ __('año de Ingreso a la UPTBolivar') }}"
						class="block font-bold tracking-wide capitalize" />
				...
				<div class="px-3 mb-6 md:w-full md:mb-0">
					...
					@else
					<x-select class="block w-full mt-1" name="nucleo" id="nucleo"  wire:model="pnf">
						<option value="">SELECCIONE</option>
						@foreach ($pnfs as $pnf_id)
							<option value="{{ $pnf_id->id }}">{{ $pnf_id->nombre }}</option>
						@endforeach
					</x-select>
					@endif
