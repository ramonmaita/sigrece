    ...
    <div class="relative">
        <div class="flex items-center justify-between mb-1">
            <div class="flex items-center h-10">
                ...
                <div class="flex rounded-lg shadow-sm md:w-3/4 lg:w-1/2 sm:w-full">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input wire:model.debounce.500ms="search" class="block py-3 pl-10 text-sm leading-4 border-gray-300 rounded-md shadow-sm sm:w-full md:w-3/4 lg:w-1/2 focus:border-yellow-300 focus:ring focus:ring-yellow-200 focus:ring-opacity-50 focus:outline-none" placeholder="{{__('Search in')}} {{ $this->searchableColumns()->map->label->join(', ') }}" type="text" />
