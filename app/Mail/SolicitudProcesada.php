...
class SolicitudProcesada extends Mailable implements ShouldQueue
{
    use Queueable, SerializesModels;
	public $subject = "Solicitud de Corrección de Calificaciones Procesada";
    ...
    {
        return $this->markdown('correos.solicitud_procesada');
    }
}
